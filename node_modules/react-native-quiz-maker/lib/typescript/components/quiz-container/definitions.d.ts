...
export declare type QuestionComponent = React.FC<MatchingQProps> | React.FC<MultipleChoiceQProps> | React.FC<WritingQProps> | never;
export declare type QuestionProps = (MatchingQProps | MultipleChoiceQProps | WritingQProps | never)[];
